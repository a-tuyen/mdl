    ...
    return (
        <div className='footer2'>
            ...
            <section className='side-section'>
                ...
                <ul >
                    <li className='testing'> <img src="https://user-images.githubusercontent.com/77664153/189227458-6398c5cc-22ab-47ea-8149-cba5ba7d6f23.png" alt='rotary telephone icon' />
                    <p>1 (877) 420 3731</p></li>

                <li>                    <img src="https://user-images.githubusercontent.com/77664153/189203263-d8200e4d-2aa4-4b03-b138-bc12c7e758f9.png" alt='globe icon' />
                    <p>info@metaldist.com</p></li>
                </ul>
