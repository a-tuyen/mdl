  ...
  return (
    <div className="about">
      <div className='main-section'>
        <div className='text'>
          <h1>About Us</h1>
          <p>Established in 1949, Metal Distributors has over 70 years of experience in the lead industry.  We pride ourselves on producing quality products and source our raw materials from only reputable sources.</p>
